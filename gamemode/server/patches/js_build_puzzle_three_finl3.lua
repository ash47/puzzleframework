...
function map_patch()
	...
	for k, v in pairs(ents.GetAll()) do
		...
		-- Patch puzzle #1
		if v:GetPos() == Vector(-8135,4877,-5898) then
			v:SetPos(Vector(-8067,-2500,-7184))
		end
		if v:GetPos() == Vector(-8134,4877,-5814) then
			v:SetPos(Vector(-8066,-2500,-7100))
		end
		...
		-- Patch puzzle #5
		if v:GetPos() == Vector(-521.44,-4896,7445) then
			v:SetPos(Vector(-518,-2494,6816))
		end
		if v:GetPos() == Vector(-521.44,-4896,7453) then
			v:SetPos(Vector(-518,-2494,6824))
		end
	end
