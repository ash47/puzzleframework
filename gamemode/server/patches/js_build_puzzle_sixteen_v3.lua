...
function map_patch()
	...
	for k, v in pairs(ents.GetAll()) do
		...
		//Delete puzzle 8:
		if v:GetPos() == Vector(-7467.96,-2177,-5415) then
			v:Remove()
		end
		if v:GetPos() == Vector(-7467.56,-2172.5,-5415) then
			v:Remove()
		end
		if v:GetPos() == Vector(-7467.96,-2199,-5415) then
			v:Remove()
		end
		
		if v:GetName() == "CARS_NOW1" then
			v:Remove()
		end
		if v:GetName() == "CARS_NOW2" then
			v:Remove()
		end
		if v:GetName() == "CARS_NOW3" then
			v:Remove()
		end
		if v:GetName() == "CARS_NOW4" then
			v:Remove()
		end
		if v:GetName() == "CARS_NOW5" then
			v:Remove()
		end
		if v:GetName() == "CARS_NOW6" then
			v:Remove()
		end
		if v:GetName() == "CARS_NOW7" then
			v:Remove()
		end
		if v:GetName() == "CARS_NOW8" then
			v:Remove()
		end
		if v:GetName() == "CARS_NOW9" then
			v:Remove()
		end
